...
async def calculate_sensitivity(request: SensitivityRequest) -> Dict[str, Any]:
    ...
    # Reconstruct VoyageCostInputs from breakdown or inputs
    speed_defaults = {
        "Handysize": (12.0, 22.0, 14000.0),
        "Supramax": (12.5, 27.0, 17000.0),
        "Panamax": (13.0, 32.0, 20000.0),
        "Capesize": (13.5, 52.0, 28000.0),
    }
    def_speed, def_fuel, def_hire = speed_defaults.get(request.base_inputs.vessel_class, (13.0, 30.0, 18000.0))
