...
class ContractOptimizationService:
    ...
    def optimize_risk_aware(
        ...
        if isinstance(inputs, dict):
            ...
            avail_str = str(inputs.get("vessel_availability", "TIGHT")).upper()
            avail = VesselAvailability[avail_str] if avail_str in VesselAvailability.__members__ else VesselAvailability.TIGHT
