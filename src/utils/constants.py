...
# Typical speed assumptions (knots) by vessel class
VESSEL_SPEEDS_KNOTS: dict[VesselClass, float] = {
    VesselClass.HANDYSIZE: 13.0,
    VesselClass.SUPRAMAX: 13.5,
    VesselClass.PANAMAX: 13.5,
    VesselClass.POST_PANAMAX: 13.0,
    VesselClass.CAPESIZE: 13.0,
    VesselClass.VLOC: 12.5,
}

# Typical daily fuel consumption at sea (tonnes/day VLSFO) by vessel class
VESSEL_FUEL_CONSUMPTION_TPD: dict[VesselClass, float] = {
    VesselClass.HANDYSIZE: 25.0,
    VesselClass.SUPRAMAX: 30.0,
    VesselClass.PANAMAX: 35.0,
    VesselClass.POST_PANAMAX: 40.0,
    VesselClass.CAPESIZE: 50.0,
    VesselClass.VLOC: 60.0,
}
