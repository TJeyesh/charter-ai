...
# Industry benchmarks for standard bulk carrier segments
DEFAULT_VESSEL_CLASSES: Dict[str, VesselClassDefinition] = {
    "Handysize": VesselClassDefinition("Handysize", 15000, 40000, 35000, 12.0, 10.5, 180.0, 28.4),
    "Supramax": VesselClassDefinition("Supramax", 40000, 60000, 55000, 12.5, 12.5, 199.9, 32.2),
    "Panamax": VesselClassDefinition("Panamax", 60000, 85000, 75000, 13.0, 14.4, 225.0, 32.2),
    "Capesize": VesselClassDefinition("Capesize", 100000, 200000, 175000, 13.5, 18.5, 292.0, 45.0),
}
