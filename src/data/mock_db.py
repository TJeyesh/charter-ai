...
def get_mock_vessel_db() -> List[VesselSpecs]:
    """Returns a deterministic list of vessel class specifications."""
    return [
        VesselSpecs(class_name="Handysize", dwt_max=40000, dwt_min=15000, typical_dwt=35000, draft_max_m=10.5, loa_max_m=180.0, beam_max_m=28.4),
        VesselSpecs(class_name="Supramax", dwt_max=60000, dwt_min=40000, typical_dwt=55000, draft_max_m=12.5, loa_max_m=199.9, beam_max_m=32.2),
        VesselSpecs(class_name="Panamax", dwt_max=85000, dwt_min=60000, typical_dwt=75000, draft_max_m=14.4, loa_max_m=225.0, beam_max_m=32.2),
        VesselSpecs(class_name="Capesize", dwt_max=200000, dwt_min=100000, typical_dwt=175000, draft_max_m=18.5, loa_max_m=292.0, beam_max_m=45.0)
    ]
...
def get_mock_port_info(port_id: str) -> PortInfo:
    ...
    port_data = {
        ...
        "IND_DHA": {"name": "Dhamra", "draft": 20.0, "loa": 350.0, "beam": 55.0, "rate": 50000, "berths": 5},
        ...
        "INA_TAB": {"name": "Taboneo", "draft": 20.0, "loa": 350.0, "beam": 55.0, "rate": 30000, "berths": 15},
    }
